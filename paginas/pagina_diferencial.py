...
class PaginaDiferencial(PaginaBase):
    def crear_widgets(self):
        ...
        ctk.CTkLabel(marco_info, text="Cálculo Diferencial", 
                    font=ctk.CTkFont(size=24, weight="bold"),
                    text_color=COLOR_DIFERENCIAL[1]).pack(pady=(20, 10))
                    
        ctk.CTkLabel(marco_info, text="🚧 Módulo en Construcción 🚧", 
                    font=ctk.CTkFont(size=16)).pack(pady=(0, 20))

        # Espacio reservado para futuras herramientas
        ...
        ctk.CTkButton(marco_placeholder, text="Próximamente: Derivadas Paso a Paso", 
                     state="disabled", fg_color=COLOR_BOTON_SECUNDARIO).pack(pady=10)
        
        ctk.CTkButton(marco_placeholder, text="Próximamente: Límites", 
                     state="disabled", fg_color=COLOR_BOTON_SECUNDARIO).pack(pady=10)
